...
// installed package surfaces the shared skills/ and prompts/ directories
// through pi's real startup resolver. No model call, no provider key.
//
// Env in:
//   PI_PKG_ROOT          root of the installed @earendil-works/pi-coding-agent
//                         package (the directory containing dist/index.js)
//   PI_CODING_AGENT_DIR  isolated pi agent dir (see docs/environment-variables.md)
...
// throws, or if any discovered resource resolves outside a skills/ or
// prompts/ directory (which would mean pi is loading something other than
// the shared core).
